# Vendored byte-for-byte from https://github.com/wetdog/wavenext_pytorch (vocos/discriminators.py),
# a fork of gemelo-ai/vocos. MIT License, Copyright (c) 2023 Charactr Inc.
# Only this header is added; the code below is upstream verbatim (einops + torchaudio.transforms
# are required by the original and are both first-party dependencies here).
